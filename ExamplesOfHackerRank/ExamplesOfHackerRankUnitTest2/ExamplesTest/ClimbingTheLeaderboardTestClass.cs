...
namespace ExamplesOfHackerRankUnitTest2.ExamplesTest
{
    [TestClass]
    public class ClimbingTheLeaderboardTestClass
    {
        [TestMethod]
        public void ClimbingTheLeaderboardTestClass_Case1()
        {
            ...
            var result = new ClimbingTheLeaderboard().climbingLeaderboard(ranked, player);


            var expect = new List<int> { 6, 5, 4, 2, 1 };
            CollectionAssert.AreEqual(expect, result);

        }

        [TestMethod]
        public void ClimbingTheLeaderboardTestClass_Case2()
        {
            ...
            var expect = new List<int> { 6, 4,2,1 };
            CollectionAssert.AreEqual(expect, result);

        }

        [TestMethod]
        public void ClimbingTheLeaderboardTestClass_Case3()
        {
